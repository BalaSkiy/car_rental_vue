        ...
        <el-table-column label="操作">
          <template #default="scope">
            ...
            <el-config-provider :locale="zhCn">
              <el-popconfirm style="margin-left: 5px" title="确定删除？" @confirm="del(scope.row.vid)">
                <template #reference>
...
<!--            </el-form-item>-->
            ...
            <el-form-item label="是否出租">
              <el-radio-group v-model="form.isrenting">
                <el-radio label="1">是</el-radio>
                <el-radio label="0">否</el-radio>
              </el-radio-group>
            </el-form-item>
