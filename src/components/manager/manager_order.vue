<template>
  <el-scrollbar>
    <div style="margin-bottom: 5px;">
      <el-input v-model="name" placeholder="请输入客户姓名" style="width:250px;" suffix-icon="search"
      ...
      <el-table-column label="操作" prop="operate">
        <template #default="scope">
          ...
          <el-config-provider :locale="zhCn">
            <el-popconfirm style="margin-left: 5px" title="是否确定删除？" @confirm="del(scope.row.oid)">
              <template #reference>
    ...
    <el-config-provider :locale="zhCn">
      ...
      >
        <el-form ref="form" :model="form" label-width="120px">
          ...
          <el-form-item label="订单状态" prop="isend">
            <el-radio-group v-model="form.isend">
              <el-radio label="0">已取消</el-radio>
              <el-radio label="1">待取车</el-radio>
              <el-radio label="2">待还车</el-radio>
...
export default {
  ...
  methods: {
    ...
    loadPost() {
      this.$axios.post(this.$httpUrl + '/orderview/listPageC', {
