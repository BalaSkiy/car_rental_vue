<template>
  <el-scrollbar>
    ...
    <el-table :data="tableData">
      ...
      <el-table-column prop="begintime" label="出库时间" width="150"/>
      ...
      <el-table-column label="操作" prop="operate">
        <template #default="scope">
          <el-button size="small" type="success" @click="mod(scope.row)">入库</el-button>
      ...
      >
        <el-form ref="form" :model="form" label-width="120px">
          ...
          <el-form-item label="出库时间" prop="begintime">
            <el-col :span="18">
              <el-input v-model="form.begintime" :disabled="dis"/>
            </el-col>
          </el-form-item>
          <el-form-item label="入库时间" prop="endtime">
            <el-col :span="18">
        ...
        <span class="dialog-footer">
          ...
          <el-button type="primary" @click="save">确定入库</el-button>
        </span>
        </template>
      </el-dialog>
    </el-config-provider>
...
export default {
  ...
  methods: {
    ...
    loadPost() {
      this.$axios.post(this.$httpUrl + '/orderview/listPageEin', {
